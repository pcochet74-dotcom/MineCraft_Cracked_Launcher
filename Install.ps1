...
function Show-Menu {
    ...
    return Read-Host "Faites votre choix (1-4)"
}
...
do {
    ...
    switch ($choice) {
        ...
        '2' {
            ...
            } else { Write-Host "Erreur : Fichier .exe introuvable." -ForegroundColor Red }
        ...
        '3' {
            ...
            try {
                ...
                Remove-Item $zipFile -Force
                Write-Host "Mods installés dans $modsPath" -ForegroundColor Green
